...
/* ── колесо крутит мир только НАД миром (M236) ──
   ...
   изуродован, и связи между этими двумя вещами не видно никакой. Колесо над
...
function tap(sxp,syp){
  /* на тросе руль у баржи: тычок не заводит автопилот, который сорвался бы
     с места по прибытии (ревью 12.09) */
  if(G.haul&&G.mode==="system"){say("НА ТРОСЕ · руль у баржи",90);return;}
