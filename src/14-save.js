...
function snapshot(){
  ...
  return {v:5,sx:G.sx,sy:G.sy,shipId:G.shipId,owned:G.owned,
    ...
    opts:G.opts,zoom:G.zoom,market:G.market,uniqueShips:(typeof stapelStrip==="function")?stapelStrip(G.uniqueShips):G.uniqueShips,stapel:G.stapel||{},thrown:G.thrown||[],railParcel:G.railParcel||null,railPass:G.railPass||null,railSeal:G.railSeal?1:0,gosDone:G.gosDone||{},bazBought:G.bazBought||null,tow:G.tow,
    ...
    drones:G.drones,droneInventory:G.droneInventory,droneIds:G.droneIds,droneSold:G.droneSold||{},homeJumps:+(G.homeJumps||0).toFixed(3),homeActMs:G.homeActMs|0,homeDockAt:G.homeDockAt||"",haul:G.haul?haulRestore(G.haul):null,crew:G.crew,bases:G.bases,
    ...
    told:G.told,lastDig:G.lastDig,mined:G.mined||{},farTaken:G.farTaken||{},draft:G.draft||{},smenaAt:G.smenaAt||{},tapeRoll:G.tapeRoll|0,tapes:G.tapes||{},actWk:G.actWk||null,
...
function applySave(s){
  ...
  G.railParcel=(s.railParcel&&typeof s.railParcel==="object")?s.railParcel:null;G.railPass=(s.railPass&&typeof s.railPass==="object")?s.railPass:null;G.railSeal=s.railSeal?1:0;G.gosDone=asMap(s.gosDone);   /* M499–M508 */
  ...
  G.homeJumps=Math.max(0,+s.homeJumps||0);G.homeActMs=Math.max(0,s.homeActMs|0);G.homeDockAt=typeof s.homeDockAt==="string"?s.homeDockAt:""; G.haul=haulRestore(s.haul);   /* спасательный буксир посреди пути (16c) */
