...
function snapshot(){
  ...
  return {v:5,sx:G.sx,sy:G.sy,shipId:G.shipId,owned:G.owned,
    ...
    opts:G.opts,zoom:G.zoom,market:G.market,uniqueShips:(typeof stapelStrip==="function")?stapelStrip(G.uniqueShips):G.uniqueShips,stapel:G.stapel||{},thrown:G.thrown||[],bazBought:G.bazBought||null,tow:G.tow,
