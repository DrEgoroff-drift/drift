...
function occTick(){
  ...
  /* до первого отбитого сектора фронт стоит (R5b, автор 12.09): один очаг —
     цель, которую видно на карте; наступление начинается с первого боя за
     систему, а не с первого часа новичка. Таять под трассой очаг может и до */
  if(!(G.freed|0))return;
