...
/* Табло прибытий. Половина строк просрочена на годы, и никто его не чистит.
   Одна из них — шлюпка «Долгого Хода» (12q, LORE_SHUTTLE): двадцать три года,
   ровно та же вёрстка, что у соседей, ни подсветки, ни пометки. Это не улика.
   Это строка на табло. Кто читал отчёт — узнает имя; кто нет — увидит ещё одну
   просроченную строку, и будет прав. */
const RET_BOARD=[["«Сажень»",38],["«Окоём»",0],["«Верста»",61],
  ["«Тесло»",23],
  ["«Лихва»",0],["«Поволока»",112],["«Ряд»",0],["«Обод»",0]];
