...
function bargeRescued(b){
  ...
  /* ── в тетрадь (11ai) ──
     Отбить баржу стоит боезапаса, корпуса и времени, и это записывается вне
     зависимости от того, сколько «в благодарность» дали, — потому что тетрадь
     считает цену, а не выручку. Игроку об этом не говорится ничем. */
  if(typeof deedAdd==="function")deedAdd("rescue",90);
}
/* ── исход: погибла ──
