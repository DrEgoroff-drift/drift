...
function hud(){
  ...
  /* Скафандр входит в повод огрублённым до пяти процентов: он течёт каждый
     кадр, и от точного значения панель горела бы на поверхности всегда — то
     есть не гасла бы там, где сидит дольше всего. А на исходе он тревога,
     и тогда панель открыта и без всяких поводов. */
