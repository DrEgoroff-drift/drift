...
function probeClaim(){
  ...
  /* покупка — вторым тапом (боты 12.09: 300 кр уходили одним касанием, а цена на
     телефоне резалась третьей строкой подсказки). Первый тап взводит на три
     секунды игры, пад переспрашивает «ТОЧНО?», второй покупает */
