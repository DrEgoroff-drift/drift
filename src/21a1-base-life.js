...
/* ── журнал (§12) ──
   Одна строка на смену, и голосом того, кого она касается. Десять видов строк —
   ровно те события, которые у базы УЖЕ есть; одиннадцатого вида нет, потому
   что писать о том, чего не происходит, — это врать в собственном журнале. */
