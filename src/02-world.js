...
const RES={
  ...
  /* У редкого сырья ДВА конца, и раньше игра называла только один: где взять.
     Плейтест 03.09.2026 — «и че куда их продавать и нафиг они нужны». Продавать
     некуда по замыслу, но это надо СКАЗАТЬ, а не оставить догадкой: `use`
     называет едока, и его печатают и трюм, и рынок, и выход из захода. */
  volatiles:{ru:"Летучие газы",col:"#7fe0c8",price:0,rare:"сбор в атмосфере газового гиганта",
    use:"верфь: точная и штучная сборка, сплав кораблей · криогенный цех на базе"},
  icecrys:  {ru:"Кристаллы льда",col:"#bfe8ff",price:0,rare:"пояс на дальней орбите",
    use:"верфь: штучная сборка и сплав кораблей"},
  techcomp: {ru:"Техкомпоненты",col:"#ffb347",price:0,ind:2,rare:"рейд на пиратскую базу · пай Приборного цеха",
    use:"приборы и оснастка баз · дальше по цепочке цехов"},
  alloy:    {ru:"Сплавы",     col:"#d9dde3",price:0,ind:1,rare:"пай Плавильного цеха · плавильня на базе",
    use:"верфь: сборка и сплав кораблей · постройки на базе"},
