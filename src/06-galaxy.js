...
const ST_TYPES=[
  {id:"trade",  ru:"Торговый узел",        tabs:["market","barter","yard","mods","crew"],
   mkt:1.08, fuel:1,    rep:1,    w:d=>2.6-d*1.9},
  {id:"indust", ru:"Промышленный комбинат",tabs:["market","smelt","mods","crew"],
   mkt:.99,  fuel:.92,  rep:.5,   w:d=>1.5-d*.4},
  {id:"yard",   ru:"Верфь",                tabs:["market","yard","mods","barter","crew"],
   mkt:.95,  fuel:1.08, rep:.75,  w:d=>1.2-d*.7},
  {id:"sci",    ru:"Научная станция",      tabs:["market","lab","mods","crew"],
   mkt:.93,  fuel:1.08, rep:1,    w:d=>1.2-d*.8},
  {id:"outpost",ru:"Пограничный аванпост", tabs:["market","mods","barter","crew"],
