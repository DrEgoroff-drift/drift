...
function parrotDraw(c,W,H){
  ...
  pg.addColorStop(0,"#3d4a5c");pg.addColorStop(.45,"#232c39");pg.addColorStop(1,"#121820");
  c.fillStyle=pg;
  c.beginPath();c.roundRect(-92,-3,184,11,5);c.fill();
  c.strokeStyle="rgba(127,230,216,.24)";c.lineWidth=1;
  ...
  g.save();
  g.translate(12,-168);
  const hr=PAR.look*.12+Math.sin(T*.5)*.022+PAR.mad*.05;
  g.rotate(hr);
