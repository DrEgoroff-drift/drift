...
/* ОТКАЗ развилки (С2): Гедеван зарезервирован планом P7 — он становится
   платным шорткатом к глифам; вязать его уход к поступку сейчас значило бы
   разбирать это при постройке блокнота. Календарь до P7. */
...
/* ОТКАЗ развилки (С2): поступок из ткани — «вы бы сами сходили» — дальний
   пеший выход, а игра дальних выходов не помнит; заводить память ради одной
   истории нельзя (класс kim_debt). */
...
/* Развилка С2 (не показывается): комиссия смотрит на стены и записывает — а
   на камне может стоять и знак игрока (wall, G.walled). Расписался до их
   отъезда — в оставленной бумаге среди линий его знак; нет — одни линии.
   Никто не говорит «из-за вас»: игрок сам узнаёт свою руку, или не узнаёт. */
{id:"commission",form:"witness",at:"stype:indust",cast:["commission"],
 traces:[
  {id:"t1",via:"cant",when:{none:["left","copied"]},scene:{seat:"far",figure:1,col:[60,64,74],props:["paper","paper","glass_empty"]}},
  {id:"t2",via:"queue",when:{none:["left","copied"]},text:"— Комиссия. Третий день. Что проверяют — не говорят. Мы на всякий случай всё покрасили."},
  {id:"t3",via:"queue",when:{visits:2,none:["left","copied"]},text:"— Они смотрят на стену и записывают. Потом на другую стену. Мы уже сами начали на стены смотреть."},
  {id:"t4",via:"news",when:{any:["left","copied"]},text:"Комиссия, направленная на комбинат, к месту назначения не прибыла. Комбинат отвечает, что комиссия была и уехала."},
  {id:"t5",via:"cant",when:{any:["left","copied"]},scene:{seat:"far",figure:0,props:["paper"]}},
  {id:"t6",via:"queue",when:{flag:"left"},text:"— Уехали. Бумагу оставили. В бумаге — ничего, одни линии. Ровные такие. Мы её не выбрасываем."},
  {id:"t7",via:"queue",when:{flag:"copied"},text:"— Уехали. Бумагу оставили. Линии — и один знак, как на камне у стойки. Мы её точно не выбрасываем."}
 ],
 turns:[{after:"seen:t1",days:7,set:"left",unless:{wall:true},else:"copied"}]},
