...
{id:"krapiva_suitcase",form:"habit",at:"fixed:9",cast:["krapiva"],
 traces:[
  {id:"t1",via:"cant",when:{noflag:"ship"},scene:{seat:"door",figure:1,col:[92,70,96],props:["paper"]}},
  {id:"t2",via:"queue",when:{noflag:"ship"},text:"— Это Крапива. Она не летает. Она сидит с билетом и ждёт баржу, а баржа её не берёт. Уже который год."},
  {id:"t3",via:"queue",when:{visits:3,noflag:"ship"},text:"— Говорит: я не летаю, я еду. Разницу не объясняет."},
 ...
 turns:[{after:"seen:t2",days:24,set:"ship"}]},
