...
const HR_COLS=12,HR_SIDE=3,HR_ROWS=5,HR_W=160,HR_SW=34,HR_SK=12,HR_FH=84,HR_TOP=46,HR_BW=200,HR_BH=136,HR_PX=2.5;
...
function drawHotel(zx,zy,Z){
  ...
  const x=zx(Ht.x),y=zy(Ht.y),k=Math.max(.22,Z*1.25),w=HR_BW*k,h=HR_BH*k;
