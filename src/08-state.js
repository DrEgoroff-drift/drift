...
/* Наблюдатель за стилем — только у тех шести узлов, которые задают пол, борт
   и верхнюю полосу: общий сторож за атрибутом style грязнил бы вёрстку КАЖДЫЙ
   кадр (шкала топлива пишет себе width на каждом кадре), а мерка пола должна
   пересчитываться только когда меняются именно эти узлы. */
try{
