...
/* непрозрачный холст (0.455): под ним ничего нет, а прозрачный компоновщик Chrome
   каждый кадр смешивал со страницей — ещё один полноэкранный проход, ~0.65 мс
   встроенной видеокарты на ×2 (A/B на ноуте автора) */
...
let CVS_RECT=null,PADS_RECT=null,LAYOUT_DIRTY=true;
