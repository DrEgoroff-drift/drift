...
const FLEET_ENG=1.3,FLEET_HALO=.45,FLEET_LOD=-1;   /* уровень на ступень мельче экрана и маска (sharp): −1.2 с маской рябил на полупикселе на 5–6 % сильнее прежних −1.2 без неё (проба рабочего), −.8 терял 1–5 % резкости вдали (ворота 25.09) */
