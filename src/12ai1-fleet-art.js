...
const FLEET_ENG=1.3,FLEET_HALO=.45,FLEET_LOD=-1.2;   /* уровень на 1.2 мельче экрана и маска (sharp): −.8 с маской терял 1–5 % резкости вдали против прежних −1.2 без неё, −1.2 с маской +2…+7 % (ворота 25.09) */
...
function fleetShipAt(f,art,ma,mb,mc,md,me,mf,al){
  ...
  /* светом звезды (Ships a): свет корпуса (GST, −1) по своей выпечке — краска как есть,
     ...
     Уровень мипа на 1.2 мельче экрана и нерезкая маска между уровнями: резкость — не ниже 2D.
