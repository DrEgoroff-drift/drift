...
/* ── и печётся она ПО КАДРАМ (M418) ──
   ...
   **383 мс одним куском**. Это 256×256 точек, и в каждой от двух до пяти
   ...
   Лечится тем же приёмом, каким до 25.09 пеклась развёртка планеты
   (ныне шейдер 17gb): работа режется на строки, за кадр отдаётся
