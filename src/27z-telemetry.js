...
function hud(){
  ...
  /* приборная колодка (25c) и трепло (12y1): свои канвы каждым кадром */
  ...
  /* Тормоз не исчезает — тормоз гаснет (M181). Правило «призрачных кнопок
     ...
     В системном режиме, однако, видимость ЦЕЛИКОМ отдана ряду ниже
     ($helmHidePads, M360/M422 — тормоз там прячется вместе с ◀▶▲, его
     держит мёртвая зона стика): раньше это правило безусловно писало
