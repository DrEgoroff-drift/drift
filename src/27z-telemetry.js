...
/* Кэш сбрасывается вместе с кэшами вёрстки и при загрузке сейва (замечание Контроля):
   кэш по ЗНАЧЕНИЮ врёт, если сам узел подменили — перестройка шапки, смена
   сцены, загрузка сейва — и полоса осталась бы пустой навсегда. */
const HUD_NUM={};
