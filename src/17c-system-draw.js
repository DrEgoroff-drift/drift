...
const RL_DL="3.",RL_KD="6.",RL_SIDE=".5",RL_AMB=".46",RL_GAS=".9",RL_LIT="1.1",RL_EM="2.3";
...
fn fieldL(p:vec2f,uv0:vec2f)->vec4f{
  ...
  if(hm&&mo){
    ...
    let e=1.-own;
    return vec4f(c4.rgb*((fl+dir)*own*mix(vec3f(1.),col,.08*key)+pl+e*${RL_EM})+lit*sk+spec+gl*(1.-a),a);}
