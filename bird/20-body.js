...
const BIRD_C={
  ...
  beak:sRGB("#f6ecd8"), beakD:sRGB("#e59a42"), beakTip:sRGB("#8a5a2a"),
...
const BIRD_SPINE=[
  ...
  [0.10, 0.62,-0.52, 0.150,0.140,0.128],
  [0.22, 0.70,-0.32, 0.208,0.194,0.180],
  [0.35, 0.80,-0.15, 0.258,0.284,0.214],
  [0.48, 0.99,-0.05, 0.278,0.330,0.232],
  [0.60, 1.19,-0.02, 0.246,0.268,0.220],
...
function bodyColor(t,a){
  ...
  const collar=smooth(.030,.004,Math.abs(t-.742)+jit*0.20)*smooth(.42,.68,belly);
