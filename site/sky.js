 ...
 * сферическим отображением фрактального шума. Кадры вращения доезжают в паузах
 * браузера, поэтому страница открывается сразу, а оборот начинается через миг.
 *
