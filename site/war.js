...
/* пределы полётного зума (п. 2 плейтеста 11.09, решено автором 12.09: «мировой
   зум ×4–5»): мир приближается до ×4.5, а корабли растут медленнее мира —
   до shipScaleCap (16c: .8 на ×1, 1.4 на ×4.5; с 18.09, прежде стояли на .8)
   — «близко» значит полпланеты в кадре, а не корабль во весь экран. Один зум
   для setZoom и для загрузки сейва */
