...
TEST_SUITES.push(() => suite("дорога: сто прыжков не раздувают ни сейв, ни карты состояния",{tier:"node"}, () => {
  resetWorld();
...
TEST_SUITES.push(() => suite("дорога: растр покинутых систем не копится в памяти",{tier:"node"}, () => {
