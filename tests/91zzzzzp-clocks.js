...
TEST_SUITES.push(()=>suite("темп: у каждого конца есть окно, и в новом мире оно закрыто",{tier:"node"},()=>{
  resetWorld();
...
/* ══════════════ приборы, которые врали (M417) ══════════════
   ...
   мерили не то. */
TEST_SUITES.push(()=>suite("сторож: провал считается от ПРОШЛОЙ метки, а не от свежей",{tier:"node"},()=>{
