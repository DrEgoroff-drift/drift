...
TEST_SUITES.push(()=>suite("Вега: дни вне дома — звонки, эфир, разбитое; дома — чинит",{tier:"node"},()=>{
...
TEST_SUITES.push(()=>suite("Вега: семь дней дома — свободна, живёт дальше, второй попугай",{tier:"node"},()=>{
  resetWorld();vegaTestHome();G.wishDevice=1;vegaWish("wait");
