...
TEST_SUITES.push(()=>suite("штурвал M422: палец где угодно, назад — тормоз",{tier:"browser"},()=>{
  ...
  /* 7. корабль стоит под пальцем: камера его НЕ уводит (P8, автор 13.09:
     «экран уезжает и корабль из-под пальца уезжает. Вот это не надо»).
     До 18.09 здесь проверялось обратное — увод M422 на 70 px */
  ...
  near(o.y,0,1e-9,"палец поверх корабля — камера стоит, корабль под пальцем");
  HELM.S=null;
