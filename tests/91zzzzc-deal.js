...
TEST_SUITES.push(()=>suite("дело: наёмник, управляющий, дрон и база — одним списком",{tier:"browser"},()=>{
  resetWorld();
...
TEST_SUITES.push(()=>suite("дело: кнопка появляется по поводу и метит простой",{tier:"browser"},()=>{
  resetWorld();
