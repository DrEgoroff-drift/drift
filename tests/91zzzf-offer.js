...
TEST_SUITES.push(()=>suite("тетрадь: невидима и пишется только с ценой",{tier:"browser"},()=>{
  resetWorld();
  G.ledger={n:0,w:0};
...
TEST_SUITES.push(()=>suite("возможность: станция не выдаёт новое по кругу",{tier:"browser"},()=>{
  resetWorld();
  G.offers=[];G.folk={};G.t=1000;
