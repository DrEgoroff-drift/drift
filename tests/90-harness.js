...
function resetWorld(){
  ...
  G.smenaAt={};G.farTaken={};G.draft={};G.tapes={};G.tapeRoll=0;G.stapel={};G.thrown=[];G.bazBought=null;G.railParcel=null;G.railPass=null;G.railSeal=0;G.gosDone={};G.recalled={};G.reg={};G.regWave=0;G.rush=null;G.soc={};G.blockHeard={};G.recallB=undefined;   /* этапы 2–6 (18.09): места глав, дальние залежи, чертежи, изолента */
