...
function resetWorld(){
  ...
  /* и где стояли фишки компаса: плашка едет к своему месту не быстрее CHIP_SPEED,
     и набор после чужого начинал с чужой кромки — «телефон: стик…» ловил фишку у
     левого края (x=4) только в -Full (пара HUD 15/n, Контроль 25.09) */
  if(typeof CHIP_POS!=="undefined")CHIP_POS.clear();
  ...
  G.mined={};G.actWk=null;G._hullHeld=null;   /* выработанные залежи, неделя налёта, корпус до беды (0.448.0) */
  G.smenaAt={};G.farTaken={};G.draft={};G.tapes={};G.tapeRoll=0;G.stapel={};G.thrown=[];G.bazBought=null;G.railParcel=null;G.railPass=null;G.railSeal=0;G.gosDone={};G.recalled={};G.reg={};G.regWave=0;G.rush=null;G.soc={};G.blockHeard={};G.giantsSeen={};G.beast=null;G.vol={};G.recallB=undefined;   /* этапы 2–6 (18.09): места глав, дальние залежи, чертежи, изолента */
  ...
  G.haul=null;G.homeJumps=0;G.homeActMs=0;   /* буксир и счётчик прыжков домой (16c, 11.09) */
