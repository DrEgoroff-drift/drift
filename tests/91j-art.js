...
TEST_SUITES.push(()=>suite("изготовитель M369: порода читается силуэтом и краской",()=>{
  resetWorld();
...
TEST_SUITES.push(()=>suite("изготовитель M369: сотня семян на класс, силуэт держится",()=>{
  resetWorld();
