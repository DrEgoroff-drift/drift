...
const search = (flag("full") ? "full=1&" : "") + (opt("only") ? "only=" + encodeURIComponent(opt("only")) + "&" : "") + (opt("shuffle") ? "shuffle=" + (+opt("shuffle") >>> 0) + "&" : "") + (opt("hour") ? "hour=" + encodeURIComponent(opt("hour")) + "&" : "") + (flag("verbose") ? "verbose=1" : "");
const G0 = globalThis;
