# Drift - patch notes archive: versions before 0.400.0

Grep-only, like `docs/PLAN-archive.md` - not meant to be read whole. The live
`PATCHNOTES.md` keeps 0.400.0 onward; find an old entry here by version:
`grep -n "^## 0.123" docs/PATCHNOTES-archive.md`.
